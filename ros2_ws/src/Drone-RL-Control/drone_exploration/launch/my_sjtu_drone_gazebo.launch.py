...
def generate_launch_description():
    ...
    x_pose = DeclareLaunchArgument("x_pose", default_value="-3.0")
    y_pose = DeclareLaunchArgument("y_pose", default_value="-2.0")
    z_pose = DeclareLaunchArgument("z_pose", default_value="0.04")
    yaw_pose = DeclareLaunchArgument("yaw_pose", default_value="0.0")
    ...
    # --- FIX 1: Point world_path directly to your actual .world file ---
    pkg_drone_exploration = get_package_share_directory("drone_exploration")
    world_path = os.path.join(pkg_drone_exploration, "worlds", "height_maze", "quad.world")

    # --- FIX 2: Set model path to the directory containing the 'models' folder ---
    models_path = os.path.join(pkg_drone_exploration, "worlds", "height_maze")

    if 'GAZEBO_MODEL_PATH' in os.environ:
        os.environ['GAZEBO_MODEL_PATH'] += os.pathsep + models_path
    else:
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            # --- FIX 3: Pass the valid file path to the server ---
